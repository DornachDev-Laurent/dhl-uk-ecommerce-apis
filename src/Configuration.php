...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-uat.dhl.com/parceluk';
    ...
    {
        $report  = 'PHP SDK (DHLUK) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api-uat.dhl.com/parceluk",
                "description" => "No description provided",
            ],
            [
                "url" => "https://api.dhl.com/parceluk",
                "description" => "No description provided",
            ]
        ];
    }
