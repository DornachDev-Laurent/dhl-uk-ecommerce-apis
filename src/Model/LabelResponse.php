...
class LabelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipmentId' => 'string',
        'labels' => '\DHLUK\Model\LabelResponseLabels[]'
    ];
     ...
     * Gets labels
     *
     * @return \DHLUK\Model\LabelResponseLabels[]|null
     */
     ...
     * Sets labels
     *
     * @param \DHLUK\Model\LabelResponseLabels[]|null $labels List of labels. If label format is PNG then all labels will be returned as one label entry in zip format encoded as Base64
     *
     * @return self
     */
