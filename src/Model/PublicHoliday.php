 ...
 */
class PublicHoliday implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'publicHoliday';
     ...
     * Sets countryCode
     *
     * @param string|null $countryCode ISO 2 character country code
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string|null $date Date of public holiday in ISO 8601 format
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Title of public holiday e.g. Christmas Day
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region Region public holiday applies to
     *
     * @return self
     */
