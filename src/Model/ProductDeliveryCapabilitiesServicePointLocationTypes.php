...
/**
 * ProductDeliveryCapabilitiesServicePointLocationTypes Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class ProductDeliveryCapabilitiesServicePointLocationTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'product_deliveryCapabilities_servicePointLocationTypes';
     ...
     * Sets locationType
     *
     * @param string|null $locationType Servicepoint location type allowed for shipment size.
     *
     * @return self
     */
