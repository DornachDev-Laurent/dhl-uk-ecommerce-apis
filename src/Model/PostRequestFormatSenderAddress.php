...
/**
 * PostRequestFormatSenderAddress Class Doc Comment
 *
 * @category Class
 * @description Sender address and contact details. This is used when passing through customs and to return back undeliverable shipments.
 * @package  DHLUK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostRequestFormatSenderAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestFormat_senderAddress';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['phone']) > 35)) {
    ...
    public function setCompanyName($companyName)
    {
        if (!is_null($companyName) && (mb_strlen($companyName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($companyName) && (mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress1($address1)
    {
        if ((mb_strlen($address1) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress3($address3)
    {
        if (!is_null($address3) && (mb_strlen($address3) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($address3) && (mb_strlen($address3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 35)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($state) && (mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if ((mb_strlen($postalCode) > 15)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling PostRequestFormatSenderAddress., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($postalCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling PostRequestFormatSenderAddress., must be bigger than or equal to 3.');
        }
    ...
    public function setCountry($country)
    {
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PostRequestFormatSenderAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PostRequestFormatSenderAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets email
     *
     * @param string $email pickup email address
     *
     * @return self
     */
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 70)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostRequestFormatSenderAddress., must be smaller than or equal to 70.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        if ((mb_strlen($phone) > 35)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PostRequestFormatSenderAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PostRequestFormatSenderAddress., must be bigger than or equal to 1.');
        }
