...
/**
 * PostResponseFormat Class Doc Comment
 *
 * @category Class
 * @description $Date: 2018-10-12 13:50:58 +0530 (Fri, 12 Oct 2018) $ $Revision: 7694 $. Its either expect Response with Shipment Details or Status,code, title and details of the response
 * @package  DHLUK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostResponseFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostResponseFormat';
    ...
    protected static $openAPITypes = [
        'shipments' => '\DHLUK\Model\PostResponseFormatShipments[]'
    ];
     ...
     * Gets shipments
     *
     * @return \DHLUK\Model\PostResponseFormatShipments[]|null
     */
     ...
     * Sets shipments
     *
     * @param \DHLUK\Model\PostResponseFormatShipments[]|null $shipments Container array for one or more shipments
     *
     * @return self
     */
