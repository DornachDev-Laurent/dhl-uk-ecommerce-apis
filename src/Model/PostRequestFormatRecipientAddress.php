<?php
/**
 * PostRequestFormatRecipientAddress
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PostRequestFormatRecipientAddress Class Doc Comment
 *
 * @category Class
 * @description Address of the recipient (not delivery address). Required if consignee/delivery address is a service point - Parcel Shop / Parcel Lockers etc.
 * @package  DHLUK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostRequestFormatRecipientAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestFormat_recipientAddress';
     ...
     * Sets companyName
     *
     * @param string|null $companyName Optional Name of the organisation receiving the shipment
     *
     * @return self
     */
    public function setCompanyName($companyName)
    {
        if (!is_null($companyName) && (mb_strlen($companyName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($companyName) && (mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets address1
     *
     * @param string $address1 Line 1 of the recipient's street address
     *
     * @return self
     */
    public function setAddress1($address1)
    {
        if ((mb_strlen($address1) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets address2
     *
     * @param string|null $address2 Line 2 of the recipient's street address
     *
     * @return self
     */
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets address3
     *
     * @param string|null $address3 Line 3 of the recipient's street address - typically used for addresses to designate province, district, or neighborhood
     *
     * @return self
     */
    public function setAddress3($address3)
    {
        if (!is_null($address3) && (mb_strlen($address3) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($address3) && (mb_strlen($address3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets city
     *
     * @param string $city recipient's city
     *
     * @return self
     */
    public function setCity($city)
    {
        if ((mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets state
     *
     * @param string|null $state recipient's county, state, province or territory.
     *
     * @return self
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 35)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($state) && (mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if ((mb_strlen($postalCode) > 15)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($postalCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 3.');
        }
     ...
     * Sets country
     *
     * @param string $country Two-character ISO recipient address country code.
     *
     * @return self
     */
    public function setCountry($country)
    {
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 70)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 70.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 35)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PostRequestFormatRecipientAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PostRequestFormatRecipientAddress., must be bigger than or equal to 1.');
        }
