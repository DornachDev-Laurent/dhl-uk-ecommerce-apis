 ...
 */
class C2CType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'C2CType';
    ...
    const SHIPMENT_MOVEMENT_TYPE_C2_C = 'C2C';
    ...
    {
        return [
            self::SHIPMENT_MOVEMENT_TYPE_C2_C,
        ];
    }
     ...
     *
     * @param string $shipmentMovementType shipmentMovementType
     *
     * @return self
     */
    ...
    public function setTotalValue($totalValue)
    {
        ...
        if (($totalValue < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $totalValue when calling C2CType., must be bigger than or equal to 0.01.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling C2CType., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling C2CType., must be bigger than or equal to 3.');
        }
