...
/**
 * PostResponseFormatShipments Class Doc Comment
 *
 * @category Class
 ...
 */
class PostResponseFormatShipments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostResponseFormat_shipments';
    ...
    protected static $setters = [
        ...
        'labels' => 'setLabels',
        'paperlessTrade' => 'setPaperlessTrade'
    ];
    ...
    protected static $getters = [
        ...
        'labels' => 'getLabels',
        'paperlessTrade' => 'getPaperlessTrade'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['paperlessTrade'] = $data['paperlessTrade'] ?? null;
    }
     ...
     * Sets shipmentId
     *
     * @param string $shipmentId shipment identifier for shipment created.
     *
     * @return self
     */
     ...
     *
     * @param string|null $returnShipmentId shipment identifier for return shipment created if inBoxReturn was set to true.
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param string[]|null $labels List of labels. If label format is PNG or JPG then all labels will be returned as one label entry in zip format encoded as Base64
     *
     * @return self
     */
    ...
    {
        return $this->container['paperlessTrade'];
    }

    /**
     * Sets paperlessTrade
     *
     * @param bool|null $paperlessTrade Indicates if paperless trade was applied for shipment. This flag is applicable for international shipments outside UK and returned only for products that support paperless trade. Paperless Trade allows the clearance of an international shipment using data only. This removes the need for physical signed invoices to be attached to each shipment.
     *
     * @return self
     */
    public function setPaperlessTrade($paperlessTrade)
    {
        $this->container['paperlessTrade'] = $paperlessTrade;
