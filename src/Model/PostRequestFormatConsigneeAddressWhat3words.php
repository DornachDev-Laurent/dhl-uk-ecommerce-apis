<?php
/**
 * PostRequestFormatConsigneeAddressWhat3words
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PostRequestFormatConsigneeAddressWhat3words Class Doc Comment
 *
 * @category Class
 * @description What 3 words identifier of a recipients delivery location. Used where addressType&#x3D;doorstep. If the what 3 words have been validated the latitude and longitude can be provided
 * @package  DHLUK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostRequestFormatConsigneeAddressWhat3words implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestFormat_consigneeAddress_what3words';
    ...
    protected static $openAPITypes = [
        'words' => 'string',
        'geo' => '\DHLUK\Model\PostRequestFormatConsigneeAddressWhat3wordsGeo'
    ];
     ...
     * Gets geo
     *
     * @return \DHLUK\Model\PostRequestFormatConsigneeAddressWhat3wordsGeo|null
     */
     ...
     * Sets geo
     *
     * @param \DHLUK\Model\PostRequestFormatConsigneeAddressWhat3wordsGeo|null $geo geo
     *
     * @return self
     */
