<?php
/**
 * PostRequestFormatExtendedLiability
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PostRequestFormatExtendedLiability Class Doc Comment
 *
 * @category Class
 * @description Optional details of extended liability cover required for this shipment
 * @package  DHLUK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostRequestFormatExtendedLiability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestFormat_extendedLiability';
    ...
    protected static $openAPITypes = [
        'extendedLiabilityUnits' => 'int',
        'extendedLiabilityRequired' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'extendedLiabilityUnits' => null,
        'extendedLiabilityRequired' => null
    ];
    ...
    protected static $attributeMap = [
        'extendedLiabilityUnits' => 'extendedLiabilityUnits',
        'extendedLiabilityRequired' => 'extendedLiabilityRequired'
    ];
    ...
    protected static $setters = [
        'extendedLiabilityUnits' => 'setExtendedLiabilityUnits',
        'extendedLiabilityRequired' => 'setExtendedLiabilityRequired'
    ];
    ...
    protected static $getters = [
        'extendedLiabilityUnits' => 'getExtendedLiabilityUnits',
        'extendedLiabilityRequired' => 'getExtendedLiabilityRequired'
    ];
    ...
    {
        $this->container['extendedLiabilityUnits'] = $data['extendedLiabilityUnits'] ?? null;
        $this->container['extendedLiabilityRequired'] = $data['extendedLiabilityRequired'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['extendedLiabilityUnits']) && ($this->container['extendedLiabilityUnits'] > 10)) {
            $invalidProperties[] = "invalid value for 'extendedLiabilityUnits', must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['extendedLiabilityUnits']) && ($this->container['extendedLiabilityUnits'] < 0)) {
            $invalidProperties[] = "invalid value for 'extendedLiabilityUnits', must be bigger than or equal to 0.";
        }
    ...
    /**
     * Gets extendedLiabilityUnits
     *
     * @return int|null
     */
    public function getExtendedLiabilityUnits()
    {
        return $this->container['extendedLiabilityUnits'];
    }

    /**
     * Sets extendedLiabilityUnits
     *
     * @param int|null $extendedLiabilityUnits For consignments delivered in the UK, the number of additional extended liability cover units required
     *
     * @return self
     */
    public function setExtendedLiabilityUnits($extendedLiabilityUnits)
    {

        if (!is_null($extendedLiabilityUnits) && ($extendedLiabilityUnits > 10)) {
            throw new \InvalidArgumentException('invalid value for $extendedLiabilityUnits when calling PostRequestFormatExtendedLiability., must be smaller than or equal to 10.');
        }
        if (!is_null($extendedLiabilityUnits) && ($extendedLiabilityUnits < 0)) {
            throw new \InvalidArgumentException('invalid value for $extendedLiabilityUnits when calling PostRequestFormatExtendedLiability., must be bigger than or equal to 0.');
        }

        $this->container['extendedLiabilityUnits'] = $extendedLiabilityUnits;

        return $this;
    }

    /**
     * Gets extendedLiabilityRequired
     *
     * @return bool|null
     */
    public function getExtendedLiabilityRequired()
    {
        return $this->container['extendedLiabilityRequired'];
    }

    /**
     * Sets extendedLiabilityRequired
     *
     * @param bool|null $extendedLiabilityRequired For consignments delivered outside the UK, is extended liability cover required?
     *
     * @return self
     */
    public function setExtendedLiabilityRequired($extendedLiabilityRequired)
    {
        $this->container['extendedLiabilityRequired'] = $extendedLiabilityRequired;
