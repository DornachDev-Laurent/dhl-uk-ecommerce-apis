...
/**
 * ClosurePeriod Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class ClosurePeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'closure-Period';
     ...
     * Sets reason
     *
     * @param string|null $reason Reason for closure
     *
     * @return self
     */
     ...
     * Sets dayDescription
     *
     * @param string|null $dayDescription Description of closure period days.
     *
     * @return self
     */
