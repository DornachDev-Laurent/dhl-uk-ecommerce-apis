 ...
 */
class C2BType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'C2BType';
    ...
    const SHIPMENT_MOVEMENT_TYPE_C2_B = 'C2B';
    ...
    {
        return [
            self::SHIPMENT_MOVEMENT_TYPE_C2_B,
        ];
    }
     ...
     *
     * @param string $shipmentMovementType Use C2B
     *
     * @return self
     */
    ...
    public function setTotalValue($totalValue)
    {
        ...
        if (($totalValue < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $totalValue when calling C2BType., must be bigger than or equal to 0.01.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling C2BType., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling C2BType., must be bigger than or equal to 3.');
        }
    ...
    public function setNumberOfItems($numberOfItems)
    {
        ...
        if (($numberOfItems < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberOfItems when calling C2BType., must be bigger than or equal to 1.');
        }
