<?php
/**
 * PostRequestFormatCustomerPrice
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PostRequestFormatCustomerPrice Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class PostRequestFormatCustomerPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestFormat_customerPrice';
    ...
    const TAX_RATE_STANDARD_UK = 'standardUk';
    const TAX_RATE_ZERO_RATED = 'zeroRated';
    ...
    {
        return [
            self::TAX_RATE_STANDARD_UK,
            self::TAX_RATE_ZERO_RATED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['taxRate']) && !in_array($this->container['taxRate'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'taxRate', must be one of '%s'",
                $this->container['taxRate'],
     ...
     * Sets price
     *
     * @param float $price Price charged to customer
     *
     * @return self
     */
     ...
     * Sets tax
     *
     * @param float $tax Tax (eg VAT) charged to customer
     *
     * @return self
     */
     ...
     * Sets taxRate
     *
     * @param string $taxRate Tax rate (eg VAT) charged to customer
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getTaxRateAllowableValues();
        if (!in_array($taxRate, $allowedValues, true)) {
