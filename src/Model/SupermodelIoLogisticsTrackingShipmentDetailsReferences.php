...
/**
 * SupermodelIoLogisticsTrackingShipmentDetailsReferences Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class SupermodelIoLogisticsTrackingShipmentDetailsReferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsTrackingShipmentDetails_references';
    ...
    const TYPE_CUSTOMER_REFERENCE = 'customer-reference';
    const TYPE_CUSTOMER_CONFIRMATION_NUMBER = 'customer-confirmation-number';
    const TYPE_LOCAL_TRACKING_NUMBER = 'local-tracking-number';
    const TYPE_ECOMMERCE_NUMBER = 'ecommerce-number';
    const TYPE_HOUSEBILL = 'housebill';
    const TYPE_MASTERBILL = 'masterbill';
    const TYPE_CONTAINER_NUMBER = 'container-number';
    const TYPE_SHIPMENT_ID = 'shipment-id';
    const TYPE_DOMESTIC_CONSIGNMENT_ID = 'domestic-consignment-id';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_CUSTOMER_CONFIRMATION_NUMBER,
            self::TYPE_LOCAL_TRACKING_NUMBER,
            self::TYPE_ECOMMERCE_NUMBER,
            self::TYPE_HOUSEBILL,
            self::TYPE_MASTERBILL,
            self::TYPE_CONTAINER_NUMBER,
            self::TYPE_SHIPMENT_ID,
            self::TYPE_DOMESTIC_CONSIGNMENT_ID,
            self::TYPE_REFERENCE,
        ];
    }
