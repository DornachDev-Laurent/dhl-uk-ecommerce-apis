...
/**
 * SupermodelIoLogisticsTrackingProofOfDelivery Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class SupermodelIoLogisticsTrackingProofOfDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsTrackingProofOfDelivery';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['signatureUrl'] = $data['signatureUrl'] ?? null;
    ...
    {
        return $this->container['signatureUrl'];
    }

    /**
     * Sets signatureUrl
     *
     * @param string|null $signatureUrl Provides the full link, including the image extension, that is used in the tracing images API to get the signature image via the imageId. The image is for the total shipment
     *
     * @return self
     */
    public function setSignatureUrl($signatureUrl)
    {
        $this->container['signatureUrl'] = $signatureUrl;
     ...
     * Sets documentUrl
     *
     * @param string|null $documentUrl Provides the full link, including the image extension, that is used in the tracing images API to get the delivery photo via the imageId. The image is for the total shipment
     *
     * @return self
     */
     ...
     * Gets signed
     *
     * @return \DHLUK\Model\SupermodelIoLogisticsSupportingPerson|null
     */
     ...
     * Sets signed
     *
     * @param \DHLUK\Model\SupermodelIoLogisticsSupportingPerson|null $signed signed
     *
     * @return self
     */
