...
/**
 * CustomsLevelOverride Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class CustomsLevelOverride implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customsLevelOverride';
    ...
    protected static $openAPITypes = [
        'senderPostcodeBegins' => 'string',
        'consigneePostcodeBegins' => 'string',
        'customsLevel' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'senderPostcodeBegins' => null,
        'consigneePostcodeBegins' => null,
        'customsLevel' => null
    ];
    ...
    protected static $attributeMap = [
        'senderPostcodeBegins' => 'senderPostcodeBegins',
        'consigneePostcodeBegins' => 'consigneePostcodeBegins',
    ...
    protected static $setters = [
        'senderPostcodeBegins' => 'setSenderPostcodeBegins',
        'consigneePostcodeBegins' => 'setConsigneePostcodeBegins',
    ...
    protected static $getters = [
        'senderPostcodeBegins' => 'getSenderPostcodeBegins',
        'consigneePostcodeBegins' => 'getConsigneePostcodeBegins',
    ...
    {
        $this->container['senderPostcodeBegins'] = $data['senderPostcodeBegins'] ?? null;
        $this->container['consigneePostcodeBegins'] = $data['consigneePostcodeBegins'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customsLevel'] === null) {
            $invalidProperties[] = "'customsLevel' can't be null";
        }
    ...
    /**
     * Gets senderPostcodeBegins
     *
     * @return string|null
     */
    public function getSenderPostcodeBegins()
    {
        return $this->container['senderPostcodeBegins'];
    }

    /**
     * Sets senderPostcodeBegins
     *
     * @param string|null $senderPostcodeBegins If sender postcode begins with this then override should apply
     *
     * @return self
     */
    public function setSenderPostcodeBegins($senderPostcodeBegins)
    {
        $this->container['senderPostcodeBegins'] = $senderPostcodeBegins;

        return $this;
    }

    /**
     * Gets consigneePostcodeBegins
     *
     * @return string|null
     */
    public function getConsigneePostcodeBegins()
    {
        return $this->container['consigneePostcodeBegins'];
    }

    /**
     * Sets consigneePostcodeBegins
     *
     * @param string|null $consigneePostcodeBegins If consignee postcode begins with this then override should apply
     *
     * @return self
     */
    public function setConsigneePostcodeBegins($consigneePostcodeBegins)
    {
        $this->container['consigneePostcodeBegins'] = $consigneePostcodeBegins;
     ...
     * Sets customsLevel
     *
     * @param string $customsLevel Customs level to apply if this override is applied
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getCustomsLevelAllowableValues();
        if (!in_array($customsLevel, $allowedValues, true)) {
