<?php
/**
 * PostRequestFormatPickupAddress
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PostRequestFormatPickupAddress Class Doc Comment
 *
 * @category Class
 * @description Pickup address, mandatory if pickup not from accountAddress
 * @package  DHLUK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostRequestFormatPickupAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestFormat_pickupAddress';
     ...
     * Sets companyName
     *
     * @param string|null $companyName Optional name of organisation
     *
     * @return self
     */
    public function setCompanyName($companyName)
    {
        if (!is_null($companyName) && (mb_strlen($companyName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($companyName) && (mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets address1
     *
     * @param string $address1 Line 1 of the street address
     *
     * @return self
     */
    public function setAddress1($address1)
    {
        if ((mb_strlen($address1) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress3($address3)
    {
        if (!is_null($address3) && (mb_strlen($address3) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($address3) && (mb_strlen($address3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 35)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($state) && (mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if ((mb_strlen($postalCode) > 15)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling PostRequestFormatPickupAddress., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($postalCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling PostRequestFormatPickupAddress., must be bigger than or equal to 3.');
        }
    ...
    public function setCountry($country)
    {
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PostRequestFormatPickupAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PostRequestFormatPickupAddress., must be bigger than or equal to 2.');
        }
     ...
     * Sets name
     *
     * @param string $name Pickup contact name
     *
     * @return self
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets email
     *
     * @param string|null $email pickup email address, either email or phone must be provided
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 70)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostRequestFormatPickupAddress., must be smaller than or equal to 70.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone phone number, either email or phone must be provided
     *
     * @return self
     */
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 35)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PostRequestFormatPickupAddress., must be smaller than or equal to 35.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PostRequestFormatPickupAddress., must be bigger than or equal to 1.');
        }
