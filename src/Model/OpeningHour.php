 ...
 */
class OpeningHour implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'openingHour';
    ...
    {
        $this->container['dayDescription'] = $data['dayDescription'] ?? null;
        $this->container['timeDescription'] = $data['timeDescription'] ?? null;
    }
     ...
     * Sets dayDescription
     *
     * @param string|null $dayDescription Description of day this open hours describes
     *
     * @return self
     */
    ...
    /**
     * Gets timeDescription
     *
     * @return string|null
     */
    public function getTimeDescription()
    {
        return $this->container['timeDescription'];
    }

    /**
     * Sets timeDescription
     *
     * @param string|null $timeDescription Description of opening hour times. NOTE. A - (dash) indicates the Service Point is not open on this day.
     *
     * @return self
     */
    public function setTimeDescription($timeDescription)
    {
        $this->container['timeDescription'] = $timeDescription;
