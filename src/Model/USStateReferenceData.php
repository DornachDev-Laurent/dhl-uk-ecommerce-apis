...
/**
 * USStateReferenceData Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class USStateReferenceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'uSStateReferenceData';
    ...
    protected static $setters = [
        'usStateCode' => 'setUsStateCode',
        'usStateName' => 'setUsStateName'
    ];
    ...
    protected static $getters = [
        'usStateCode' => 'getUsStateCode',
        'usStateName' => 'getUsStateName'
    ];
    ...
    {
        $this->container['usStateCode'] = $data['usStateCode'] ?? null;
        $this->container['usStateName'] = $data['usStateName'] ?? null;
    }
    ...
    {
        return $this->container['usStateCode'];
    }

    /**
     * Sets usStateCode
     *
     * @param string|null $usStateCode United States 2 character US State Code
     *
     * @return self
     */
    public function setUsStateCode($usStateCode)
    {
        $this->container['usStateCode'] = $usStateCode;
     ...
     * @return string|null
     */
    public function getUsStateName()
    {
        return $this->container['usStateName'];
    }

    /**
     * Sets usStateName
     *
     * @param string|null $usStateName United States US State Name
     *
     * @return self
     */
    public function setUsStateName($usStateName)
    {
        $this->container['usStateName'] = $usStateName;
