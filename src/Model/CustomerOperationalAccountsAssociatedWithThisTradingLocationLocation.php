<?php
/**
 * CustomerOperationalAccountsAssociatedWithThisTradingLocationLocation
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * CustomerOperationalAccountsAssociatedWithThisTradingLocationLocation Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class CustomerOperationalAccountsAssociatedWithThisTradingLocationLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Customer_operational_accounts_associated_with_this_trading_location_location';
     ...
     * Sets accountId
     *
     * @param string|null $accountId Unique Id for operational account
     *
     * @return self
     */
