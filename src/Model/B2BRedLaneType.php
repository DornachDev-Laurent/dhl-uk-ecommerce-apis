...
/**
 * B2BRedLaneType Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class B2BRedLaneType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'B2BRedLaneType';
    ...
    public function setTotalValue($totalValue)
    {
        ...
        if (($totalValue < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $totalValue when calling B2BRedLaneType., must be bigger than or equal to 0.01.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling B2BRedLaneType., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling B2BRedLaneType., must be bigger than or equal to 3.');
        }
    ...
    public function setNumberOfItems($numberOfItems)
    {
        ...
        if (($numberOfItems < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberOfItems when calling B2BRedLaneType., must be bigger than or equal to 1.');
        }
