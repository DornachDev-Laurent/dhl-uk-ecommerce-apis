...
/**
 * IossValueLimit Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class IossValueLimit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'iossValueLimit';
    ...
    protected static $setters = [
        ...
        'maxTotalValue' => 'setMaxTotalValue'
    ];
    ...
    protected static $getters = [
        ...
        'maxTotalValue' => 'getMaxTotalValue'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['maxTotalValue'] = $data['maxTotalValue'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['maxTotalValue'] === null) {
            $invalidProperties[] = "'maxTotalValue' can't be null";
        }
     ...
     * Sets currency
     *
     * @param string $currency Currency code this ioss value limit applies to
     *
     * @return self
     */
    ...
    {
        return $this->container['maxTotalValue'];
    }

    /**
     * Sets maxTotalValue
     *
     * @param float $maxTotalValue Max total value for this currency
     *
     * @return self
     */
    public function setMaxTotalValue($maxTotalValue)
    {
        $this->container['maxTotalValue'] = $maxTotalValue;
