...
/**
 * ReasonForExport Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class ReasonForExport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reasonForExport';
    ...
    const TYPE_COMMERCIAL_SALE = 'commercialSale';
    const TYPE_GIFT = 'gift';
    const TYPE_COMMERCIAL_SAMPLE = 'commercialSample';
    const TYPE_DOCUMENTS = 'documents';
    const TYPE_PERSONAL_BELONGINGS = 'personalBelongings';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_GIFT,
            self::TYPE_COMMERCIAL_SAMPLE,
            self::TYPE_DOCUMENTS,
            self::TYPE_PERSONAL_BELONGINGS,
        ];
    }
