...
/**
 * LabelResponseLabels Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class LabelResponseLabels implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'labelResponse_labels';
     ...
     * Sets label
     *
     * @param string|null $label Base64 encoded label of the requested format.
     *
     * @return self
     */
