<?php
/**
 * PostRequestFormatRecipientCustomsRegistrations
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PostRequestFormatRecipientCustomsRegistrations Class Doc Comment
 *
 * @category Class
 * @package  DHLUK
 * @author   OpenAPI Generator team
 ...
 */
class PostRequestFormatRecipientCustomsRegistrations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestFormat_recipientCustomsRegistrations';
     ...
     * Sets id
     *
     * @param string $id Customs registration identifier, must be between 10 and 20 characters if type is EORI.
     *
     * @return self
     */
